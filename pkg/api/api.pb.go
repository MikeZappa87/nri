...
const (
	...
	Event_NETWORK_NAMESPACE_SETUP Event = 12
	Event_NETWORK_SETUP           Event = 13
	Event_LAST                    Event = 14
)
...
type StateChangeEvent struct {
	...
	Netns     *PodNetworkNamespace `protobuf:"bytes,4,opt,name=netns,proto3" json:"netns,omitempty"`
}
...
func (x *StateChangeEvent) GetNetns() *PodNetworkNamespace {
	if x != nil {
		return x.Netns
	}
	return nil
...
type PodNetworkNamespace struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	//name could be cni network configuration name
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// interface name and PodInterface
	Interfaces map[string]*PodInterface `protobuf:"bytes,2,rep,name=interfaces,proto3" json:"interfaces,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Routes     []*PodRoute              `protobuf:"bytes,3,rep,name=routes,proto3" json:"routes,omitempty"`
	NetnsPath  string                   `protobuf:"bytes,4,opt,name=netns_path,json=netnsPath,proto3" json:"netns_path,omitempty"`
	Dns        *PodDNS                  `protobuf:"bytes,5,opt,name=dns,proto3" json:"dns,omitempty"`
}

func (x *PodNetworkNamespace) Reset() {
	*x = PodNetworkNamespace{}
	if protoimpl.UnsafeEnabled {
...
func (x *PodNetworkNamespace) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PodNetworkNamespace) ProtoMessage() {}

func (x *PodNetworkNamespace) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_api_api_proto_msgTypes[17]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PodNetworkNamespace.ProtoReflect.Descriptor instead.
func (*PodNetworkNamespace) Descriptor() ([]byte, []int) {
	return file_pkg_api_api_proto_rawDescGZIP(), []int{17}
}

func (x *PodNetworkNamespace) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *PodNetworkNamespace) GetInterfaces() map[string]*PodInterface {
	if x != nil {
		return x.Interfaces
	}
	return nil
...
func (x *PodNetworkNamespace) GetRoutes() []*PodRoute {
	if x != nil {
		return x.Routes
	}
	return nil
...
func (x *PodNetworkNamespace) GetNetnsPath() string {
	if x != nil {
		return x.NetnsPath
	}
	return ""
...
func (x *PodNetworkNamespace) GetDns() *PodDNS {
	if x != nil {
		return x.Dns
	}
	return nil
...
type PodInterface struct {
	...
	//possible use case is <"vrf", 12> where the extension data could provide this
	ExtensionData map[string]string `protobuf:"bytes,4,rep,name=extension_data,json=extensionData,proto3" json:"extension_data,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (x *PodInterface) Reset() {
	*x = PodInterface{}
	if protoimpl.UnsafeEnabled {
...
func (x *PodInterface) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PodInterface) ProtoMessage() {}

func (x *PodInterface) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_api_api_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PodInterface.ProtoReflect.Descriptor instead.
func (*PodInterface) Descriptor() ([]byte, []int) {
	return file_pkg_api_api_proto_rawDescGZIP(), []int{18}
}

func (x *PodInterface) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *PodInterface) GetIpAddress() string {
	if x != nil {
		return x.IpAddress
	}
	return ""
...
func (x *PodInterface) GetMacAddress() string {
	if x != nil {
		return x.MacAddress
	}
	return ""
...
func (x *PodInterface) GetExtensionData() map[string]string {
	if x != nil {
...
type PodRoute struct {
	...
	//possible use case is <src, x.x.x.x> where the src attribute could be returned.
	//This gets messy fast or at least it could. Better typed objects is the way.
	ExtensionData map[string]string `protobuf:"bytes,4,rep,name=extension_data,json=extensionData,proto3" json:"extension_data,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *PodRoute) GetNextHop() string {
	if x != nil {
		return x.NextHop
	}
	return ""
...
func (x *PodRoute) GetExtensionData() map[string]string {
	if x != nil {
		return x.ExtensionData
	}
	return nil
...
func (x *PodDNS) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PodDNS) ProtoMessage() {}

func (x *PodDNS) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_api_api_proto_msgTypes[20]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PodDNS.ProtoReflect.Descriptor instead.
func (*PodDNS) Descriptor() ([]byte, []int) {
	return file_pkg_api_api_proto_rawDescGZIP(), []int{20}
}

func (x *PodDNS) GetNameservers() []string {
	if x != nil {
...
func (x *PodDNS) GetDomain() string {
	if x != nil {
		return x.Domain
	}
	return ""
...
func (x *PodDNS) GetSearch() []string {
	if x != nil {
		return x.Search
	}
	return nil
...
func (x *PodDNS) GetOptions() []string {
	if x != nil {
		return x.Options
	}
	return nil
...
var file_pkg_api_api_proto_rawDesc = []byte{
	...
	0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x22, 0xf9, 0x01, 0x0a, 0x10, 0x53, 0x74, 0x61, 0x74, 0x65,
	...
	0x72, 0x12, 0x3f, 0x0a, 0x05, 0x6e, 0x65, 0x74, 0x6e, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x29, 0x2e, 0x6e, 0x72, 0x69, 0x2e, 0x70, 0x6b, 0x67, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76,
	0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x50, 0x6f, 0x64, 0x4e, 0x65, 0x74, 0x77, 0x6f,
	0x72, 0x6b, 0x4e, 0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x52, 0x05, 0x6e, 0x65, 0x74,
	0x6e, 0x73, 0x22, 0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0xee, 0x03, 0x0a, 0x0a,
	...
	,
	...
	0x52, 0x0a, 0x6d, 0x61, 0x63, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x5c, 0x0a, 0x0e,
	0x65, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x04,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x35, 0x2e, 0x6e, 0x72, 0x69, 0x2e, 0x70, 0x6b, 0x67, 0x2e, 0x61,
	0x70, 0x69, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x50, 0x6f, 0x64, 0x49,
	0x6e, 0x74, 0x65, 0x72, 0x66, 0x61, 0x63, 0x65, 0x2e, 0x45, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69,
	...
	0x08, 0x50, 0x6f, 0x64, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x64, 0x73, 0x74,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x64, 0x73, 0x74, 0x12, 0x25, 0x0a, 0x0e, 0x69,
	...
	0x6d, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x6e, 0x65, 0x78, 0x74, 0x5f, 0x68, 0x6f, 0x70, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6e, 0x65, 0x78, 0x74, 0x48, 0x6f, 0x70, 0x12, 0x58, 0x0a,
	0x0e, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18,
	0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x31, 0x2e, 0x6e, 0x72, 0x69, 0x2e, 0x70, 0x6b, 0x67, 0x2e,
	0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x50, 0x6f, 0x64,
	0x52, 0x6f, 0x75, 0x74, 0x65, 0x2e, 0x45, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x44,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x74, 0x0a, 0x06, 0x50, 0x6f, 0x64,
	...
	0x81, 0x05, 0x0a, 0x09, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x12, 0x0e, 0x0a,
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x22, 0xa5, 0x04, 0x0a, 0x0e,
	...
	0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x1a, 0x3a, 0x0a, 0x0c, 0x55, 0x6e, 0x69, 0x66, 0x69,
	...
	0x93, 0x03, 0x0a, 0x13, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x41, 0x64, 0x6a,
	...
	0x6c, 0x69, 0x6e, 0x75, 0x78, 0x1a, 0x3e, 0x0a, 0x10, 0x41, 0x6e, 0x6e, 0x6f, 0x74, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76,
	0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75,
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xbe, 0x01, 0x0a, 0x18, 0x4c, 0x69, 0x6e, 0x75, 0x78, 0x43,
	...
	0x70, 0x73, 0x50, 0x61, 0x74, 0x68, 0x22, 0x9d, 0x01, 0x0a, 0x0f, 0x43, 0x6f, 0x6e, 0x74, 0x61,
	...
	0x65, 0x2a, 0xcc, 0x02, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x0b, 0x0a, 0x07, 0x55,
	...
	0x49, 0x4e, 0x45, 0x52, 0x10, 0x0b, 0x12, 0x1b, 0x0a, 0x17, 0x4e, 0x45, 0x54, 0x57, 0x4f, 0x52,
	0x4b, 0x5f, 0x4e, 0x41, 0x4d, 0x45, 0x53, 0x50, 0x41, 0x43, 0x45, 0x5f, 0x53, 0x45, 0x54, 0x55,
	0x50, 0x10, 0x0c, 0x12, 0x11, 0x0a, 0x0d, 0x4e, 0x45, 0x54, 0x57, 0x4f, 0x52, 0x4b, 0x5f, 0x53,
	0x45, 0x54, 0x55, 0x50, 0x10, 0x0d, 0x12, 0x08, 0x0a, 0x04, 0x4c, 0x41, 0x53, 0x54, 0x10, 0x0e,
...
var file_pkg_api_api_proto_goTypes = []interface{}{
	...
	(*PodNetworkNamespace)(nil),      // 19: nri.pkg.api.v1alpha1.PodNetworkNamespace
	(*PodInterface)(nil),             // 20: nri.pkg.api.v1alpha1.PodInterface
	(*PodRoute)(nil),                 // 21: nri.pkg.api.v1alpha1.PodRoute
	(*PodDNS)(nil),                   // 22: nri.pkg.api.v1alpha1.PodDNS
	...
	(*ContainerAdjustment)(nil),      // 35: nri.pkg.api.v1alpha1.ContainerAdjustment
	(*LinuxContainerAdjustment)(nil), // 36: nri.pkg.api.v1alpha1.LinuxContainerAdjustment
	(*ContainerUpdate)(nil),          // 37: nri.pkg.api.v1alpha1.ContainerUpdate
	(*LinuxContainerUpdate)(nil),     // 38: nri.pkg.api.v1alpha1.LinuxContainerUpdate
	(*ContainerEviction)(nil),        // 39: nri.pkg.api.v1alpha1.ContainerEviction
	(*KeyValue)(nil),                 // 40: nri.pkg.api.v1alpha1.KeyValue
	(*OptionalString)(nil),           // 41: nri.pkg.api.v1alpha1.OptionalString
	(*OptionalInt)(nil),              // 42: nri.pkg.api.v1alpha1.OptionalInt
	(*OptionalInt32)(nil),            // 43: nri.pkg.api.v1alpha1.OptionalInt32
	(*OptionalUInt32)(nil),           // 44: nri.pkg.api.v1alpha1.OptionalUInt32
	(*OptionalInt64)(nil),            // 45: nri.pkg.api.v1alpha1.OptionalInt64
	(*OptionalUInt64)(nil),           // 46: nri.pkg.api.v1alpha1.OptionalUInt64
	(*OptionalBool)(nil),             // 47: nri.pkg.api.v1alpha1.OptionalBool
	(*OptionalFileMode)(nil),         // 48: nri.pkg.api.v1alpha1.OptionalFileMode
	nil,                              // 49: nri.pkg.api.v1alpha1.PodSandbox.LabelsEntry
	nil,                              // 50: nri.pkg.api.v1alpha1.PodSandbox.AnnotationsEntry
	nil,                              // 51: nri.pkg.api.v1alpha1.PodNetworkNamespace.InterfacesEntry
	nil,                              // 52: nri.pkg.api.v1alpha1.PodInterface.ExtensionDataEntry
	nil,                              // 53: nri.pkg.api.v1alpha1.PodRoute.ExtensionDataEntry
...
var file_pkg_api_api_proto_depIdxs = []int32{
	37, // 0: nri.pkg.api.v1alpha1.UpdateContainersRequest.update:type_name -> nri.pkg.api.v1alpha1.ContainerUpdate
	39, // 1: nri.pkg.api.v1alpha1.UpdateContainersRequest.evict:type_name -> nri.pkg.api.v1alpha1.ContainerEviction
	37, // 2: nri.pkg.api.v1alpha1.UpdateContainersResponse.failed:type_name -> nri.pkg.api.v1alpha1.ContainerUpdate
	17, // 3: nri.pkg.api.v1alpha1.SynchronizeRequest.pods:type_name -> nri.pkg.api.v1alpha1.PodSandbox
	23, // 4: nri.pkg.api.v1alpha1.SynchronizeRequest.containers:type_name -> nri.pkg.api.v1alpha1.Container
	37, // 5: nri.pkg.api.v1alpha1.SynchronizeResponse.update:type_name -> nri.pkg.api.v1alpha1.ContainerUpdate
	17, // 6: nri.pkg.api.v1alpha1.CreateContainerRequest.pod:type_name -> nri.pkg.api.v1alpha1.PodSandbox
	23, // 7: nri.pkg.api.v1alpha1.CreateContainerRequest.container:type_name -> nri.pkg.api.v1alpha1.Container
	35, // 8: nri.pkg.api.v1alpha1.CreateContainerResponse.adjust:type_name -> nri.pkg.api.v1alpha1.ContainerAdjustment
	37, // 9: nri.pkg.api.v1alpha1.CreateContainerResponse.update:type_name -> nri.pkg.api.v1alpha1.ContainerUpdate
	39, // 10: nri.pkg.api.v1alpha1.CreateContainerResponse.evict:type_name -> nri.pkg.api.v1alpha1.ContainerEviction
	17, // 11: nri.pkg.api.v1alpha1.UpdateContainerRequest.pod:type_name -> nri.pkg.api.v1alpha1.PodSandbox
	23, // 12: nri.pkg.api.v1alpha1.UpdateContainerRequest.container:type_name -> nri.pkg.api.v1alpha1.Container
	31, // 13: nri.pkg.api.v1alpha1.UpdateContainerRequest.linux_resources:type_name -> nri.pkg.api.v1alpha1.LinuxResources
	37, // 14: nri.pkg.api.v1alpha1.UpdateContainerResponse.update:type_name -> nri.pkg.api.v1alpha1.ContainerUpdate
	39, // 15: nri.pkg.api.v1alpha1.UpdateContainerResponse.evict:type_name -> nri.pkg.api.v1alpha1.ContainerEviction
	17, // 16: nri.pkg.api.v1alpha1.StopContainerRequest.pod:type_name -> nri.pkg.api.v1alpha1.PodSandbox
	23, // 17: nri.pkg.api.v1alpha1.StopContainerRequest.container:type_name -> nri.pkg.api.v1alpha1.Container
	37, // 18: nri.pkg.api.v1alpha1.StopContainerResponse.update:type_name -> nri.pkg.api.v1alpha1.ContainerUpdate
	...
	23, // 21: nri.pkg.api.v1alpha1.StateChangeEvent.container:type_name -> nri.pkg.api.v1alpha1.Container
	19, // 22: nri.pkg.api.v1alpha1.StateChangeEvent.netns:type_name -> nri.pkg.api.v1alpha1.PodNetworkNamespace
	49, // 23: nri.pkg.api.v1alpha1.PodSandbox.labels:type_name -> nri.pkg.api.v1alpha1.PodSandbox.LabelsEntry
	50, // 24: nri.pkg.api.v1alpha1.PodSandbox.annotations:type_name -> nri.pkg.api.v1alpha1.PodSandbox.AnnotationsEntry
	18, // 25: nri.pkg.api.v1alpha1.PodSandbox.linux:type_name -> nri.pkg.api.v1alpha1.LinuxPodSandbox
	31, // 26: nri.pkg.api.v1alpha1.LinuxPodSandbox.pod_overhead:type_name -> nri.pkg.api.v1alpha1.LinuxResources
	31, // 27: nri.pkg.api.v1alpha1.LinuxPodSandbox.pod_resources:type_name -> nri.pkg.api.v1alpha1.LinuxResources
	28, // 28: nri.pkg.api.v1alpha1.LinuxPodSandbox.namespaces:type_name -> nri.pkg.api.v1alpha1.LinuxNamespace
	31, // 29: nri.pkg.api.v1alpha1.LinuxPodSandbox.resources:type_name -> nri.pkg.api.v1alpha1.LinuxResources
	51, // 30: nri.pkg.api.v1alpha1.PodNetworkNamespace.interfaces:type_name -> nri.pkg.api.v1alpha1.PodNetworkNamespace.InterfacesEntry
	21, // 31: nri.pkg.api.v1alpha1.PodNetworkNamespace.routes:type_name -> nri.pkg.api.v1alpha1.PodRoute
	22, // 32: nri.pkg.api.v1alpha1.PodNetworkNamespace.dns:type_name -> nri.pkg.api.v1alpha1.PodDNS
	52, // 33: nri.pkg.api.v1alpha1.PodInterface.extension_data:type_name -> nri.pkg.api.v1alpha1.PodInterface.ExtensionDataEntry
	53, // 34: nri.pkg.api.v1alpha1.PodRoute.extension_data:type_name -> nri.pkg.api.v1alpha1.PodRoute.ExtensionDataEntry
	1,  // 35: nri.pkg.api.v1alpha1.Container.state:type_name -> nri.pkg.api.v1alpha1.ContainerState
	54, // 36: nri.pkg.api.v1alpha1.Container.labels:type_name -> nri.pkg.api.v1alpha1.Container.LabelsEntry
	55, // 37: nri.pkg.api.v1alpha1.Container.annotations:type_name -> nri.pkg.api.v1alpha1.Container.AnnotationsEntry
	24, // 38: nri.pkg.api.v1alpha1.Container.mounts:type_name -> nri.pkg.api.v1alpha1.Mount
	25, // 39: nri.pkg.api.v1alpha1.Container.hooks:type_name -> nri.pkg.api.v1alpha1.Hooks
	27, // 40: nri.pkg.api.v1alpha1.Container.linux:type_name -> nri.pkg.api.v1alpha1.LinuxContainer
	26, // 41: nri.pkg.api.v1alpha1.Hooks.prestart:type_name -> nri.pkg.api.v1alpha1.Hook
	26, // 42: nri.pkg.api.v1alpha1.Hooks.create_runtime:type_name -> nri.pkg.api.v1alpha1.Hook
	26, // 43: nri.pkg.api.v1alpha1.Hooks.create_container:type_name -> nri.pkg.api.v1alpha1.Hook
	26, // 44: nri.pkg.api.v1alpha1.Hooks.start_container:type_name -> nri.pkg.api.v1alpha1.Hook
	26, // 45: nri.pkg.api.v1alpha1.Hooks.poststart:type_name -> nri.pkg.api.v1alpha1.Hook
	26, // 46: nri.pkg.api.v1alpha1.Hooks.poststop:type_name -> nri.pkg.api.v1alpha1.Hook
	42, // 47: nri.pkg.api.v1alpha1.Hook.timeout:type_name -> nri.pkg.api.v1alpha1.OptionalInt
	28, // 48: nri.pkg.api.v1alpha1.LinuxContainer.namespaces:type_name -> nri.pkg.api.v1alpha1.LinuxNamespace
	29, // 49: nri.pkg.api.v1alpha1.LinuxContainer.devices:type_name -> nri.pkg.api.v1alpha1.LinuxDevice
	31, // 50: nri.pkg.api.v1alpha1.LinuxContainer.resources:type_name -> nri.pkg.api.v1alpha1.LinuxResources
	42, // 51: nri.pkg.api.v1alpha1.LinuxContainer.oom_score_adj:type_name -> nri.pkg.api.v1alpha1.OptionalInt
	48, // 52: nri.pkg.api.v1alpha1.LinuxDevice.file_mode:type_name -> nri.pkg.api.v1alpha1.OptionalFileMode
	44, // 53: nri.pkg.api.v1alpha1.LinuxDevice.uid:type_name -> nri.pkg.api.v1alpha1.OptionalUInt32
	44, // 54: nri.pkg.api.v1alpha1.LinuxDevice.gid:type_name -> nri.pkg.api.v1alpha1.OptionalUInt32
	45, // 55: nri.pkg.api.v1alpha1.LinuxDeviceCgroup.major:type_name -> nri.pkg.api.v1alpha1.OptionalInt64
	45, // 56: nri.pkg.api.v1alpha1.LinuxDeviceCgroup.minor:type_name -> nri.pkg.api.v1alpha1.OptionalInt64
	32, // 57: nri.pkg.api.v1alpha1.LinuxResources.memory:type_name -> nri.pkg.api.v1alpha1.LinuxMemory
	33, // 58: nri.pkg.api.v1alpha1.LinuxResources.cpu:type_name -> nri.pkg.api.v1alpha1.LinuxCPU
	34, // 59: nri.pkg.api.v1alpha1.LinuxResources.hugepage_limits:type_name -> nri.pkg.api.v1alpha1.HugepageLimit
	41, // 60: nri.pkg.api.v1alpha1.LinuxResources.blockio_class:type_name -> nri.pkg.api.v1alpha1.OptionalString
	41, // 61: nri.pkg.api.v1alpha1.LinuxResources.rdt_class:type_name -> nri.pkg.api.v1alpha1.OptionalString
	56, // 62: nri.pkg.api.v1alpha1.LinuxResources.unified:type_name -> nri.pkg.api.v1alpha1.LinuxResources.UnifiedEntry
	30, // 63: nri.pkg.api.v1alpha1.LinuxResources.devices:type_name -> nri.pkg.api.v1alpha1.LinuxDeviceCgroup
	45, // 64: nri.pkg.api.v1alpha1.LinuxMemory.limit:type_name -> nri.pkg.api.v1alpha1.OptionalInt64
	45, // 65: nri.pkg.api.v1alpha1.LinuxMemory.reservation:type_name -> nri.pkg.api.v1alpha1.OptionalInt64
	45, // 66: nri.pkg.api.v1alpha1.LinuxMemory.swap:type_name -> nri.pkg.api.v1alpha1.OptionalInt64
	45, // 67: nri.pkg.api.v1alpha1.LinuxMemory.kernel:type_name -> nri.pkg.api.v1alpha1.OptionalInt64
	45, // 68: nri.pkg.api.v1alpha1.LinuxMemory.kernel_tcp:type_name -> nri.pkg.api.v1alpha1.OptionalInt64
	46, // 69: nri.pkg.api.v1alpha1.LinuxMemory.swappiness:type_name -> nri.pkg.api.v1alpha1.OptionalUInt64
	47, // 70: nri.pkg.api.v1alpha1.LinuxMemory.disable_oom_killer:type_name -> nri.pkg.api.v1alpha1.OptionalBool
	47, // 71: nri.pkg.api.v1alpha1.LinuxMemory.use_hierarchy:type_name -> nri.pkg.api.v1alpha1.OptionalBool
	46, // 72: nri.pkg.api.v1alpha1.LinuxCPU.shares:type_name -> nri.pkg.api.v1alpha1.OptionalUInt64
	45, // 73: nri.pkg.api.v1alpha1.LinuxCPU.quota:type_name -> nri.pkg.api.v1alpha1.OptionalInt64
	46, // 74: nri.pkg.api.v1alpha1.LinuxCPU.period:type_name -> nri.pkg.api.v1alpha1.OptionalUInt64
	45, // 75: nri.pkg.api.v1alpha1.LinuxCPU.realtime_runtime:type_name -> nri.pkg.api.v1alpha1.OptionalInt64
	46, // 76: nri.pkg.api.v1alpha1.LinuxCPU.realtime_period:type_name -> nri.pkg.api.v1alpha1.OptionalUInt64
	...
	40, // 79: nri.pkg.api.v1alpha1.ContainerAdjustment.env:type_name -> nri.pkg.api.v1alpha1.KeyValue
	25, // 80: nri.pkg.api.v1alpha1.ContainerAdjustment.hooks:type_name -> nri.pkg.api.v1alpha1.Hooks
	36, // 81: nri.pkg.api.v1alpha1.ContainerAdjustment.linux:type_name -> nri.pkg.api.v1alpha1.LinuxContainerAdjustment
	29, // 82: nri.pkg.api.v1alpha1.LinuxContainerAdjustment.devices:type_name -> nri.pkg.api.v1alpha1.LinuxDevice
	31, // 83: nri.pkg.api.v1alpha1.LinuxContainerAdjustment.resources:type_name -> nri.pkg.api.v1alpha1.LinuxResources
	38, // 84: nri.pkg.api.v1alpha1.ContainerUpdate.linux:type_name -> nri.pkg.api.v1alpha1.LinuxContainerUpdate
	31, // 85: nri.pkg.api.v1alpha1.LinuxContainerUpdate.resources:type_name -> nri.pkg.api.v1alpha1.LinuxResources
	20, // 86: nri.pkg.api.v1alpha1.PodNetworkNamespace.InterfacesEntry.value:type_name -> nri.pkg.api.v1alpha1.PodInterface
...
func file_pkg_api_api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pkg_api_api_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PodNetworkNamespace); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
